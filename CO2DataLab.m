...
bioamp = maxbio - minbio;
figure(10); clf
worldmap world
contourfm(latgrid, longrid, bioamp','linecolor','none');
colorbar
geoshow('landareas.shp','FaceColor','black')
title('Seasonal Biological Drawdown of Seawater pco2 (ppm)')

maxtemp = nanmax(tempaffct, [], 3);
mintemp = nanmin(tempaffct,[],3);
tempamp = maxtemp - mintemp;
figure(11); clf
worldmap world
contourfm(latgrid, longrid, tempamp','linecolor','none');
colorbar
geoshow('landareas.shp','FaceColor','black')
title('Seasonal Temperature Effect on Seawater pco2 (ppm)')

tbdiff= tempamp - bioamp;
figure(12); clf
worldmap world
contourfm(latgrid, longrid, tbdiff','linecolor','none');
colorbar
geoshow('landareas.shp','FaceColor','black')
title('The Difference (T-B) between the effects on pco2(ppm) of seasonal temperature changes and biology')
